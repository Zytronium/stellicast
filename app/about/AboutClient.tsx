  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <section className="w-full max-w-5xl py-20 px-6 text-center animate-fade-in-up">
        <div className="w-auto h-24 -mt-24 mb-24">
          <Image
              src="/stellicast.png"
              alt="Stellicast"
              width={2997}
      ...
      <section className="w-full max-w-5xl mx-auto py-6 px-6 text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-3 px-6 py-3 rounded-full font-extrabold text-black bg-gradient-to-r from-cyan-300 to-sky-400 shadow-lg shadow-cyan-500/30 transition-all duration-300 hover:scale-105 hover:shadow-cyan-400/50 focus:outline-none focus:ring-4 focus:ring-cyan-300/40 active:scale-95">
